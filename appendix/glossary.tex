...
\newglossaryentry{Routing-Graph}{
    ...
    description={Ein Verbund von Vertices, welche über Kanten miteinander verbunden sind und ein Strassen- und Wegenetzwerk abbildet, über das Routen berechnet werden können.}
}
