...
Insgesamt kann zwischen den beiden Varianten in Sachen Tooling keinen Unterschied festgestellt werden.
...
Für die Integration der Fahrplan-Daten und der Routing-Engine für die Berechnung der \glspl{Isochrone} ist eine Integration mit PostgreSQL nötig.
