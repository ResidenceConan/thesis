...
Um die \glspl{Isochrone} berechnen zu können, muss auf dem Routing-Graphen zuerst ein Startpunkt ermittelt werden, von dem das Routing entlang der Strassen und Wege ausgeht.
...
Problematisch wird dies aber etwa bei grossen Bahnhöfen wie der Zürcher Hauptbahnhof.
...
Für Fussgängerflächen könnte eine Methode dafür sein, zusätzliche Graph-Kanten einzufügen, wie es etwa in~\cite{plaza_route} beschrieben wurde.
