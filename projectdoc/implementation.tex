...
Aus den Fahrplandaten ist nicht einfach zu erkennen, welche Züge als Fernverkehr gelten.
...
Die Bahnhöfe wurden daher aus der Liste manuell in ein CSV geschrieben~\cite{github:oevgk18-generator}, das in die Datenbank eingelesen wird.
...
Ein erster Ansatz dieses "`Snappings"' sucht mithilfe einer "`\gls{Nearest Neighbor Suche}"' den geographisch nächstliegenden Vertex des Routing-Graphen zu den Koordinaten der Haltestelle.
