...
In unserem Projekt wird \ac{CI} einerseits für das automatische Erstellen dieser Dokumentation mit LaTeX verwendet, und andererseits, um automatische Tests für die Backend-Implementation auszuführen.
...
\subsubsection{CI für die Web-Applikation}
...
Eine entsprechende Umgebung ist bereits vorhanden, womit der Konfigurationsaufwand sehr klein bleibt.
