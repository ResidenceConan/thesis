...
Für den ersten Teil wird die Spezifikation ''Güteklassen 2018'' definiert, die auf der Norm SN 640 290~\cite{sn640290} sowie den aktuellen Berechnungsmethoden des \ac{ARE}~\cite{berechnung_are} aufsetzt und diese mit den oben genannten Punkten erweitert.

Im zweiten Teil wird die erarbeitete Spezifikation umgesetzt.
Mit einem reproduzierbarem Skript werden die Güteklassen für mehrere Parameter berechnet.
...
Darin können neben unseren Berechnungen auch die bisherigen Güteklassen (''Güteklassen 1993'') angezeigt werden.
