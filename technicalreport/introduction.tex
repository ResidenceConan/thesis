...
Bei der Definition der ''\acs{ÖV}-Güteklassen 2018''-Spezifikation liegt der Fokus auf einer möglichst einfachen Verwendung dieser. 
...
Dieses Ziel wird bei der Definition berücksichtigt, sodass nicht beispielsweise öffentliche Transportmittelkategorien festgelegt werden, welche in den Fahrplandaten nicht ausgewiesen sind.
