...
Ebenfalls sieht man für diese Haltestelle die Korrektur, welche das Bundesamt für Raumentwicklung für Verbindungen vornimmt, welche nur in eine Richtung befahren werden.
So wird die Anzahl Verbindungen in diesem Fall verdoppelt.

An diesem Tag werden im Intervall 06:00 bis 20:00 Uhr 56 Fahrten an dieser Haltestelle registriert.
Folgt man der Berechnungslogik des Bundesamt für Raumentwicklung erfolgt daraus folgender Intervall:
$ 840 / ((56 * 2) / 2) = 15 min$
...
Der Unterschied macht sich in der Bestimmung der Haltestellenkategorie.
Da es sich bei dieser Haltestelle um eine Busstation handelt, fällt man nach der OeVGK93- und OeVGK18-Spezifikation von der Haltestellekategorie IV in die Kategorie V.

Abschliessend kann man sagen, dass 23.1 Minuten eine bessere Annäherung ist an den Kursintervall ist und somit das wahrnehmbare Angebot an der Haltestelle besser wiederspiegelt.
