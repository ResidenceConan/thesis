...
Ob die definierten Kriterien mit der vorhandenen Datenbasis umsetzbar ist und ob diese für eine schweizweite Umsetzung tauglich ist, ist Bestandteil dieser Analyse.
...
Stand 13.03.2017 kommt die GTFS Route Type Kategorie 5 gemäss den Fahrplandaten~\cite{geops_fahrplandaten} in der Schweiz nicht vor und kann vernachlässigt werden.
...
Es existieren unterschiedliche Berechnungsmethodike, welche auf der Norm \cite{sn640290} aufsetzen und modifizieren.
