...
Anmerken muss man, dass zu besserer Verständlichkeit und Übersichtlichkeit zusätzliche Terminologie wie Verkehrsmittelkategorie eingeführt wird.
...
Es werden zwei zusätzliche Haltestellenkategorieren VI und VII (siehe Tabelle \ref{table:Ermittlung der Haltestellenkategorie (Kanton Graubünden)}) ergänzt und eine feinere Gliederung der Taktfrequenz eingeführt.
...
Die zusätzlichen Haltestellenkategorien (VI und VII) hat zur Folge, dass auch zwei zusätzliche Güteklassen E und F eingeführt werden (siehe Tabelle \ref{table:Ermittlung Erreichbarkeit der Haltestelle (Kanton Graubünden)}).
...
Aus Sicht eines Benutzers dieser Haltestelle handelt es sich eher um einen 60-minütigen Kursintervall.
...
Dies wäre jedoch auf zwei Ebenen falsch, da in der Spezifikation dies nicht erwähnt wird und dass beispielsweise die Haltestelle Zürich Flughafen nicht als Bahnknoten identifiziert ist.
