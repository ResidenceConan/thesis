...
Die öffentlichen Verkehrsmittel werden zuerst in die in Tabelle \ref{table:Verkehrsmittelkategorien} ersichtlichen Verkehrsmittelkategorien eingeteilt.
...
\begin{table}[ht]
    \begin{tabular}{l p{10.6cm}}
        ...
        \bottomrule
    \end{tabular}
    \caption{Verkehrsmittelkategorien}
    \label{table:Verkehrsmittelkategorien}
\end{table}
