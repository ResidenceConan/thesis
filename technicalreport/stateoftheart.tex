...
Um eine Bahnstation als Bahnknoten zu kategorisieren, wird wie bei der \nameref{Lösungsansätze:Berechnungsmethodik Kanton Zürich} verlangt, dass die Bahnstation entweder einen Anschluss an den Fernverkehr (national oder international) besitzt, oder die Anzahl Richtungen nach obiger Definition mindestens 6 beträgt.